-- V62: db-scheduler table for distributed task scheduling
-- Single table used by db-scheduler for cluster-safe job coordination.
-- See: https://github.com/kagkarlsson/db-scheduler
